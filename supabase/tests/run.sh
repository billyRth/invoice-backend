...
for t in rules payments signals; do
  ...
  for m in 0001_init 0002_payments 0004_lock_down_functions 0005_districts 0006_district_centres 0007_null_uid_guards 0008_default_privileges 0009_signals_and_telegram 0011_lock_new_functions 0012_lock_the_locker; do
